...
const Whale = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <path
      d="M2.2 26.4s-.4 3.3 0 6c1.3 7.9 7.5 18.4 24.9 18.4c10.8 0 13-1.4 17.8-4.9c.7-.5 1.3-1 1.8-1.5C31.5 48.5 20 37 20 27.9c0-1.6-11.8-2.1-17.8-1.5"
      fill="#dae5ef"
    />
    <g fill="#ffffff">
    ...
    <path
      d="M30.8 27c0 .9-.7 1.6-1.5 1.6s-1.5-.7-1.5-1.6c0-.9.7-1.6 1.5-1.6c.8-.1 1.5.6 1.5 1.6"
      fill="#3e4347"
    />
    <path
      d="M26.6 28.6c.1 0 4.1 2.8 5.4-.6c.7-1.8-5.4.6-5.4.6"
      fill="#0dccd1"
    />
    <g fill="#3e4347">
    ...
    <path
      d="M47 44.2c.7 4.8-.6 11.2-3.3 11.8c-2.7.6-5.8-4.8-6.5-9.6c-.7-4.8 1.2-7.1 3.9-7.7c2.7-.7 5.2.7 5.9 5.5"
      fill="#0dccd1"
    />
  </svg>
);
